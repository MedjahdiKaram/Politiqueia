  ...
  return (
    <div className="flex flex-1 items-center justify-center px-4 py-16">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-zinc-900">Quelque chose s&apos;est mal passé</h1>
        <p className="mt-4 text-zinc-500 max-w-sm mx-auto">
          Une erreur est survenue lors du chargement de cette page. Réessayez ou revenez au tableau de bord.
        </p>
