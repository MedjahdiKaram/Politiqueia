  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-4xl font-bold text-zinc-900">Quelque chose s&apos;est mal passé</h1>
        <p className="mt-4 text-zinc-500 max-w-sm mx-auto">
          Une erreur est survenue lors du chargement de cette page. Vous pouvez réessayer ou revenir à l&apos;accueil.
        </p>
